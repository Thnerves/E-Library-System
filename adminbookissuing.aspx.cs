    ...
    public partial class adminbookissuing : System.Web.UI.Page
    {
        ...
        void returnBook()
        {
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    cmd = new SqlCommand("update book_master_tbls set current_stock = current_stock+1 WHERE book_id='" + TextBox1.Text.Trim() + "'", con);
                    cmd.ExecuteNonQuery();
                    con.Close();
        ...
        bool checkIfBookExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from book_master_tbls WHERE book_id='" + TextBox1.Text.Trim() + "' AND current_stock >0", con);
        ...
        void getNames()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select book_name from book_master_tbls WHERE book_id='" + TextBox1.Text.Trim() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                if (dt.Rows.Count >= 1)
